...
function getSunriseAndSunset(logFile, timezoneOffset, res, didGetForecasts, onClose) {
  var sun = []
...
function router_get(cityIndex, req, res, didGetForecasts) {
  ...
  getSunriseAndSunset(weatherLogFile, timezoneOffset, res, didGetForecasts, function(sun){
    getForecasts(forecastLogFile, sun, timezoneOffset, function(forecasts) {
      didGetForecasts(forecasts, "", cityIndex, res, "")
    });
  })
...
function getForecast(cityIndex, req, res, didGetForecasts) {
  var cityInfo = getCityInfoByIndex(cityIndex)
  requestForecast(cityInfo.id, function(){
    router_get(cityIndex, req, res, didGetForecasts)
  })
}
